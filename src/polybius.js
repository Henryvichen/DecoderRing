...
const direction = encode ? encoder : decoder; // which table you are using
    
return input
    .match(/[0-9]{2}|[a-z]|\s/g)
    .map(character => direction[character] || character) // if not found in table, use character
    .join(''); // make all join together
};
